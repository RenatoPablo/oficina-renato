    ...
    <div class="container mt-4">
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body">
                ...
                {{-- Barra de pesquisa --}}
                <form method="GET" action="{{ route('veiculo.index') }}" class="mb-4">
                    <div class="row g-2">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2 d-flex gap-1">
                            ...
                            @if(request()->anyFilled(['tipo','marca','modelo','placa','cliente']))
                                <a href="{{ route('veiculo.index') }}" class="btn btn-secondary" title="Limpar filtros">
                                    Limpar
                                </a>
                            @endif
                        </div>
                ...
                <div class="table-wrap">
                    <table class="table table-hover table-striped align-middle table-padrao">
                        ...
                        <tbody>
                            @forelse ($veiculos as $veiculo)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('veiculo.edit', ['id' => Crypt::encrypt($veiculo->id)]) }}" class="btn btn-warning btn-sm" title="Editar">
                                        ...
                                        <form action="{{ route('veiculo.destroy', ['id' => Crypt::encrypt($veiculo->id)]) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Tem certeza que deseja excluir este veículo?')" title="Excluir">
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" class="text-center text-muted">Nenhum veículo cadastrado.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
